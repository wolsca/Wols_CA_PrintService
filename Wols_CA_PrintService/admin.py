...
FIELDS = [
    ...
    {"key": "settings.print_mode", "label": "Default print mode", "type": "select",
     "options": list(config.PRINT_MODES)},
    ...
    {"key": "hardware.flip_confirmation", "label": "Flip confirmed by", "type": "select",
     "options": ["auto", "printer", "service"]},
    {"key": "hardware.single_page_paper_change", "label": "Single page paper change",
     "type": "select", "options": ["off", "printer", "pause", "blank"]},
    {"key": "hardware.single_page_media_source", "label": "Single page paper tray",
     "type": "select", "options": ["manual", "tray-1", "tray-2", "auto"]},
